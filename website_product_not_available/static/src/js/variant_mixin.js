odoo.define('website_product_not_available.VariantMixin', function (require) {
'use strict';
...
var xml_load = ajax.loadXML(
    '/website_product_not_available/static/src/xml/website_sale_stock_product_availability.xml',
    QWeb
);
