...
class StockPicking(models.Model):
    ...
    def _action_done(self):
        ...
        todo_moves.with_context(picking_date_done=self.date_done)._action_done(cancel_backorder=self.env.context.get('cancel_backorder'))
    ...
    def onchange_date_done(self):
        self.date = self.scheduled_date = self.date_done
        self.move_ids_without_package.date = self.date_done
